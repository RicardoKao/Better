...
public class MeFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private MaterialListView melistview;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        swipeLayout = (SwipeRefreshLayout) view.findViewById(R.id.me_swipe_container);
        ...
        melistview = (MaterialListView) view.findViewById(R.id.me_plans);
        melistview.getAdapter().addAll(cards);
        return view;
    }
}